...
class InitialBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<ThumbnailCacheService>(
          () => ThumbnailCacheService(),
      fenix: true,
    );

    Get.lazyPut<ExifService>(
          () => ExifService(),
      fenix: true,
    );

    Get.lazyPut<MediaIndexService>(
          () => MediaIndexService(
        thumbnailCache: Get.find<ThumbnailCacheService>(),
      ),
      fenix: true,
    );
    ...
    Get.lazyPut<MediaRepository>(
          () => MediaRepositoryImpl(
        indexService: Get.find<MediaIndexService>(),
        exifService: Get.find<ExifService>(),
      ),
      fenix: true,
    );
    ...
    Get.lazyPut<AlbumRepository>(
          () => AlbumRepositoryImpl(
        mediaRepo: Get.find<MediaRepository>(),
        indexService: Get.find<MediaIndexService>(),
      ),
      fenix: true,
    );
    ...
    Get.lazyPut<SecureMediaRepository>(
          () => SecureMediaRepositoryImpl(
        secureStorage: Get.find<SecureStorageService>(),
      ),
      fenix: true,
    );
